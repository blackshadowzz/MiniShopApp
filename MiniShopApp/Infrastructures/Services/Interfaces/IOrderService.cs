...
namespace MiniShopApp.Infrastructures.Services.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<Result<string>> ModifiedStatusAsync(OrderStatusDto statuses, CancellationToken cancellationToken=default);
        Task<Result<string>> ModifiedStatusAsync(List<OrderStatusDto> statuses, CancellationToken cancellationToken=default);
